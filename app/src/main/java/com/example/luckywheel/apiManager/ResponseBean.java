...
public class ResponseBean {
    ...
    @SerializedName("tripcoinBalance")
    private int tripcoinBalance;
    @SerializedName("wheels")
    private ArrayList<WheelsBean> wheels = new ArrayList<>();
    ...
    public int getTripcoinBalance() {
        return tripcoinBalance;
    }

    public void setTripcoinBalance(int tripcoinBalance) {
        this.tripcoinBalance = tripcoinBalance;
    }

    public ArrayList<WheelsBean> getWheels() {
        return wheels;
    }

    public void setWheels(ArrayList<WheelsBean> wheels) {
        this.wheels = wheels;
    }
}
